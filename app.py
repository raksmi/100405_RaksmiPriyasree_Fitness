...
def dashboard_page():
    ...
    with col1:
        st.metric("📊 Plans Generated", st.session_state.workouts_generated)
    with col2:
        st.metric("🎯 Goals Set", "0")
    with col3:
        st.metric("⏱️ Total Hours", "0")
    with col4:
    ...
    with col1:
        ...
        CoachBot AI is here to help you:
    ...
    features = {
        "BMI Calculator": "Calculate your BMI and get health recommendations",
        "Personalized Plans": "AI-generated workout and nutrition plans",
        "Sport-Specific": "Tailored for your sport and position",
        "Injury Prevention": "Safe training with recovery strategies",
        "24/7 AI Coach": "Get help anytime with your fitness questions"
    }
